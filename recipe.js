...
function createRecipeCard(recipe, index) {
  ...
  backFace.innerHTML = `
    ...
    <div class="delete-button" onclick="deleteRecipe(${index})">Delete</div>
  `;
...
function deleteRecipe(index) {
  ...
  saveRecipes(); // Save the updated recipes to Local Storage
  generateRecipeCards(); // Regenerate the recipe cards
}
